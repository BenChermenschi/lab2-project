#rotationfixer (use only if stepper motors aren't aligned properly!!!!! (i should really find a better way to do this) 

#130 = 1 cycle for up or down
...
for i in range(0,rotations):
	print "iteration"
	moveDown(stepper1,stepper2,0.05)
	print i 
